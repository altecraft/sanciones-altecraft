...
//        $millis = ($dt->getTimestamp() + $dt->getOffset()) * 1000;
   ...
   function print_player_heads() {
        ...
        $url = 'https://api.mcsrvstat.us/1/' . $this->settings->query_ip;
        ...
        foreach($json['players']['list'] as $players) {
        echo '<img src="https://minotar.net/avatar/' . $players . '/50.png" title="' . $players . '" id="player-head"</img>';
        }    
      }    
    }
